<template>
	<section class='fill-height minh'>
		<v-row v-if='init && !flightInit && !online' align='center' class='minh' justify='center'>
			<v-col class='ma-0 pa-0' cols='12'>
				<AppOffline />
			</v-col>
			<v-col class='ma-0 pa-0' cols='12' lg='11'>
				<PiInfo :update-count @refresh='refresh' />
			</v-col>
		</v-row>

		<section v-else>
			<v-row v-if='init && flightInit && online' align='center' class='ma-0 pa-0 ' justify='center'>
				<v-col class='ma-0 pa-0' cols='12'>
						...
						<v-col class='ma-0 pa-0' cols='12' lg='11'>
							...
							<v-row align='center' class='ma-0 pa-0' justify='space-between'>
								...
								<v-col class='ma-0 pa-0' cols='4'>
									<v-row align='center' class='ma-0 pa-0' justify='center'>
										<v-col class='ma-0 pa-0' cols='auto'>
											<ForceUpdate :update-count @refresh='refresh' />
										</v-col>
									</v-row>
								</v-col>
